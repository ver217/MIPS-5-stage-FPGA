...
set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { show_loaduse_count }]; #IO_L13N_T2_MRCC_14 Sch=sw[3]
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { show_mem }]; #IO_L12N_T1_MRCC_14 Sch=sw[4]
...
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { _go }]; #IO_L10N_T1_D15_14 Sch=btnr
